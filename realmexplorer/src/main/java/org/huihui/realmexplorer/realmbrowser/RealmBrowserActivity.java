...
import org.huihui.realmexplorer.R;
import org.huihui.realmexplorer.realmbrowser.utils.L;
import org.huihui.realmexplorer.realmbrowser.utils.MagicUtils;
...
public class RealmBrowserActivity extends AppCompatActivity implements RealmAdapter.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            if (realmFileName.equals("default")) {
                RealmConfiguration config = new RealmConfiguration.Builder()
                        .name(realmFileName.replace(".realm", ""))
                        .build();
